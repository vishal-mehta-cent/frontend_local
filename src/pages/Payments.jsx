...
const PLANS = [
  ...
  { id: "monthly", name: "Monthly", price: 129, strike: 500, desc: "Introductory monthly access", period: "Per month", features: ["Trading App (Watchlist, Orders, Portfolio, History + Real-time charts & tracking)"] },
